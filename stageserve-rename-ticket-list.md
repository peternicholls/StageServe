...
## Next Stage Spec Work
**007** Version management, releases, and update workflows
- Semantic version managment flow and tracking
- Release workflow, including github release and tagging, for downloads
- Update workflows, release management, and self update for CLI.
- Effective use of CI workflows

**008** Documentation Update and Decluter
- Update the README.md so it is user facing, not contributor heavy
- Plan and write a user manual that is human readble docs, which should also include a html version and a TUI version, nicely formated, in sections, with quick guide and also a step by step guide
- write a `man stack` Comman manual for CLI
- Make sure all commands are easily discoverable
- Decluter all documentation, organise in to correctly relevant sections User, Developer (contributor), and add in the appropriate contributor documentation and workflows
