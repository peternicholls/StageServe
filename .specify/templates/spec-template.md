...
- Affected runtime state: [containers, volumes, networks, routing, DNS,
...
- Docs and interfaces requiring updates: [e.g., `README.md`,
  `AUTOMATION-README.md`, `GUI-HELP.md`, shell help text, app dialogs]
